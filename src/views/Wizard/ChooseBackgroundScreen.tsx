// src/views/Wizard/ChooseBackgroundScreen.tsx
...
const ChooseBackgroundScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Elige tu fondo favorito</Text>
        <Text style={styles.subtitle}>
          Personaliza la apariencia de Vocablox
        </Text>
      </View>
